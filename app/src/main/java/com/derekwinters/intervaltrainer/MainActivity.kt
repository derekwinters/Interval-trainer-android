...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // or navigation bar, is a property of :designsystem's own layouts (DS-080,
        // docs/spec/design-system.md §8) —
        // https://github.com/derekwinters/Interval-trainer-android/issues/131. ListLayout,
        // FullBleedLayout and FormLayout apply that padding; this activity does not, and neither
        // does any screen in this module, per that page's sixth invariant.
